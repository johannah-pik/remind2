 ...
 out <- mbind(out,
  ...
  if (tran_mod == "edge_esm") {
    ...
    out <- mbind(out,
      ...
      setNames(dimSums(vm_demFeForEs_trnsp[,,"esdie_frgt_sm",pmatch=TRUE],dim=3,na.rm=T),"FE|Transport|Freight|Short-Medium distance|Liquids (EJ/yr)"),
      ...
      setNames(dimSums(vm_demFeForEs_trnsp[,,c("espet_pass_sm", "esdie_pass_sm"),pmatch=TRUE],dim=3,na.rm=T),"FE|Transport|Pass|Short-Medium distance|Liquids (EJ/yr)"),
      ...
      setNames(dimSums(vm_demFeForEs_trnsp[,,"esdie_frgt_lo",pmatch=TRUE],dim=3,na.rm=T),"FE|Transport|Freight|Long distance|Liquids (EJ/yr)"),
      ...
      setNames(dimSums(vm_demFeForEs_trnsp[,,"esdie_pass_lo",pmatch=TRUE],dim=3,na.rm=T),"FE|Transport|Pass|Long distance|Liquids (EJ/yr)"),
